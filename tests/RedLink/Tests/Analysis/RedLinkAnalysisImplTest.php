...
class RedLinkAnalysisImplTest extends \PHPUnit_Framework_TestCase
{
    ...
    const API_KEY = "QVBU1skUrDBlapFOeHZZHa3uqs1fI3vwb67d6405"; //FIXME
    const ANALYSIS_NAME = "php-sdk";
    ...
    public function testEnhance() {
        $analysisRequest = \RedLink\Analysis\AnalysisRequestBuilder::builder()->setAnalysis(self::ANALYSIS_NAME)->setContent(self::TEXT_TO_ENHANCE)->build();
