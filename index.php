...
$request = \RedLink\Analysis\AnalysisRequestBuilder::builder()->setAnalysis("alfresco")->setContent("Paris is the capital of France")->setOutputFormat("xml")->build();
//echo $analysisClient->enhanceRaw($request);
var_dump($analysisClient->enhance($request));
